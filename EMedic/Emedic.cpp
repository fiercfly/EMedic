...
void output(patient *p, ofstream &outfile)
{
...
void linkedqueue::insertatend()
{
    ...
    *p = input();
    ...
    cout << "\n  \xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\n";
    cout << "\n  ----------PATIENT ADDED-----------";
    outfile<<"Critically Ill Patient added";
    output(p, outfile);
    outfile.close();
}
...
void linkedqueue::getpatientout()
{
    ...
    else
    {
        ...
        cout << "\n  Patient to operate:";
        outfile <<"Patient sent for Operation";
        output(p, outfile);
...
void departmentmenu(linkedqueue *q)
{
    ...
    while (choice != 5)
    {
        ...
        choice = readnumber();
        cout << "  \xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd";
